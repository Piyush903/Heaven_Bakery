...
public class Product {
	...
	// Now creating a Category variable 
	// We need to map Category with Product in our database
	// Many to one is used because many products can belong to one category
	...
	// We will be storing names of image in our database;
	...
	// Generating Getters and Setters for all of the above fields...
